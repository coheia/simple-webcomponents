...
@customElement('swc-i-github-octocat')
export class SwcIGithubOctocat extends LitElement {
...
<svg width="${this.size}" height="${this.size}" viewBox="-1.65 0 259.3 259.3" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
    <g>
